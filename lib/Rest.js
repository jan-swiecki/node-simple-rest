    ...
    //   });
      ...
      return self.requestRouter.findHandlerForRequest(req, res)
        ...
        .then(async obj => {
          ...
          let result = self.injector.exec(handler.callback, pathVarsMap);
...
Rest.prototype.promiseResponse = function(result, functionName) {
  ...
  return new Promise(function(resolve, reject) {
    log("result.promise -> "+(result ? result.promise : "null"));
    ...
    function getResponse(returnValue) {
      ...
      if(typeof returnValue !== 'undefined') {
        ...
        if(result == null) {
          ...
          response = new Response(JSON_prune(returnValue), contentType || "application/json").setStatusCode(statusCode);
        } else {
